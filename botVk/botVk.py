...
text_cfg = 'Начиная с 07.06.2021 мы больше не продаём cfg в группе, тогда же мы выложили пак со всеми конфигурациями на тот момент в открытый доступ. Вы можете скачать его по ссылке - https://vk.cc/cpaOc7.Если вам нужны более поздние версии конфигов, вы можете попробовать приобрести их у игроков лично.'
